    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('clothes_photo', models.FileField(upload_to='clothes_video/')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('clothes_connect', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='color', to='store.clothes')),
            ],
        ),
        migrations.CreateModel(
            name='Favorite',
            fields=[
                ...
                ('clothes', models.ManyToManyField(related_name='favorite_clothes', to='store.clothes')),
